...
module Repositories
  class HolidaysController < ApplicationController
    ...
    def set_repository_and_contributor
      ...
      @contributor = @repository.contributors.find(params[:contributor_id])
    end
    ...
    def holiday_destroyed_streams
      ...
      if @contributor.holidays.none?
        streams << turbo_stream.append('holidays', partial: 'repositories/holidays/empty_state')
      end
      streams
    end
    ...
    def holiday_count_stream
      turbo_stream.replace('holiday-count',
                           partial: 'repositories/holidays/count',
